# -*- coding: utf-8 -*-
from jrpc import x
vals={'name':'كشف حساب العون A4','format':'A4','orientation':'Portrait','margin_top':8,'margin_bottom':14,
...
x('ir.actions.report','write',[784,822],{'paperformat_id':pid})
print('paperformat',pid,'مربوط بالتقريرين 784 و 822')
