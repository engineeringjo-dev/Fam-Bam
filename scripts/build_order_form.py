...
ws['E7'] = ('=IF(B7="","— اكتب عدد بنود الورقة أولاً",'
...
for rng in ['B3:D3', 'F3', 'H3:I3', 'B4:D4', 'F4', 'H4:I4', 'B7', 'B8',
...
STEPS = [
    ...
    ('10', 'العدّاد فوق بيعدّ لحالو. ما بتصير الحالة خضراء إلا لما كل بند يتدقّق وعدد البنود يطابق الورقة.'),
